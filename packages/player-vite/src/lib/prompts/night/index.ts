...
- 存活玩家: [${playerList}]
- 当前轮次: 第${context.round}轮
- 今晚被杀玩家ID: ${context.nightDeaths && context.nightDeaths.length > 0 ? context.nightDeaths[0] : 0} (0表示无人被杀)
- 历史事件: ${historyEvents}
...
export function getRoleNightAction(playerServer: PlayerServer, context: PlayerContext): string {
