...
// OpenTelemetry SDK 实例 (disabled for Vercel compatibility)
...
export function initializeLangfuse() {
  ...
  // OpenTelemetry SDK disabled for Vercel compatibility
  // Direct Langfuse integration will be used instead
...
export function logEvent(
  ...
  try {
    ...
    if (!parent) {
      activePhaseTrace.forEach((traceId, key) => {
